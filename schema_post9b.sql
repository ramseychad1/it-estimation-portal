...
\restrict 9QuFDe3C4nB8v8uvkgLPcrgKXVqmIVEumbedp9JACsKYYgR9q9OoHBdGMpJwOEY
...
--
-- Name: estimate_request_items; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.estimate_request_items (
    id bigint NOT NULL,
    ...
    CONSTRAINT estimate_request_items_complexity_chk CHECK (((complexity IS NULL) OR ((complexity)::text = ANY ((ARRAY['LOW'::character varying, 'MED'::character varying, 'HIGH'::character varying])::text[])))),
    CONSTRAINT estimate_request_items_status_chk CHECK (((status)::text = ANY ((ARRAY['DRAFT'::character varying, 'SUBMITTED'::character varying, 'IN_REVIEW'::character varying, 'APPROVED'::character varying, 'REJECTED'::character varying])::text[])))
);


--
-- Name: COLUMN estimate_request_items.rejection_reason; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.estimate_request_items.rejection_reason IS 'SO''s explanation when rejecting an item. Cleared when requester revises and resubmits.';


--
-- Name: COLUMN estimate_request_items.revision_count; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.estimate_request_items.revision_count IS 'Incremented each time the requester revises this item. Useful for audit display.';


--
-- Name: COLUMN estimate_request_items.original_product_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.estimate_request_items.original_product_id IS 'Set to the original product_id on the first product swap during revision. Null until a swap occurs; unchanged on subsequent swaps (preserves the original trail).';


--
-- Name: estimate_request_items_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.estimate_request_items_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: estimate_request_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.estimate_request_items_id_seq OWNED BY public.estimate_request_items.id;
...
CREATE TABLE public.estimate_request_phase_lines (
    ...
    sdlc_phase_display_order_snapshot integer CONSTRAINT estimate_request_phase_line_sdlc_phase_display_order_s_not_null NOT NULL,
...
CREATE TABLE public.estimate_request_question_answers (
    ...
    question_text_snapshot text CONSTRAINT estimate_request_question_answe_question_text_snapshot_not_null NOT NULL,
    answer_text text NOT NULL,
    estimate_request_item_id bigint CONSTRAINT estimate_request_question_ans_estimate_request_item_id_not_null NOT NULL
);
...
--
-- Name: estimate_request_items id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.estimate_request_items ALTER COLUMN id SET DEFAULT nextval('public.estimate_request_items_id_seq'::regclass);
...
--
-- Name: estimate_request_items estimate_request_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.estimate_request_items
    ADD CONSTRAINT estimate_request_items_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.estimate_request_phase_lines
    ADD CONSTRAINT estimate_request_phase_lines_unique UNIQUE (estimate_request_item_id, sdlc_phase_id);
...
ALTER TABLE ONLY public.estimate_request_question_answers
    ADD CONSTRAINT estimate_request_question_answers_unique UNIQUE (estimate_request_item_id, critical_question_id);
...
--
-- Name: estimate_request_items_product_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX estimate_request_items_product_idx ON public.estimate_request_items USING btree (product_id);


--
-- Name: estimate_request_items_request_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX estimate_request_items_request_idx ON public.estimate_request_items USING btree (estimate_request_id);


--
-- Name: estimate_request_items_reviewer_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX estimate_request_items_reviewer_idx ON public.estimate_request_items USING btree (reviewer_id) WHERE (reviewer_id IS NOT NULL);


--
-- Name: estimate_request_items_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX estimate_request_items_status_idx ON public.estimate_request_items USING btree (status);


--
-- Name: estimate_request_phase_lines_item_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX estimate_request_phase_lines_item_idx ON public.estimate_request_phase_lines USING btree (estimate_request_item_id);


--
-- Name: estimate_request_question_answers_item_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX estimate_request_question_answers_item_idx ON public.estimate_request_question_answers USING btree (estimate_request_item_id);


--
-- Name: estimate_requests_requester_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX estimate_requests_requester_idx ON public.estimate_requests USING btree (requester_id);
...
--
-- Name: uq_request_item_atomic; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_request_item_atomic ON public.estimate_request_items USING btree (estimate_request_id, product_id) WHERE (sub_feature_id IS NULL);


--
-- Name: uq_request_item_subfeature; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_request_item_subfeature ON public.estimate_request_items USING btree (estimate_request_id, product_id, sub_feature_id) WHERE (sub_feature_id IS NOT NULL);
...
--
-- Name: estimate_request_items estimate_request_items_set_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER estimate_request_items_set_updated_at BEFORE UPDATE ON public.estimate_request_items FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: estimate_request_items estimate_request_items_approved_blended_rate_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.estimate_request_items
    ADD CONSTRAINT estimate_request_items_approved_blended_rate_id_fkey FOREIGN KEY (approved_blended_rate_id) REFERENCES public.blended_rates(id) ON DELETE RESTRICT;


--
-- Name: estimate_request_items estimate_request_items_estimate_request_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.estimate_request_items
    ADD CONSTRAINT estimate_request_items_estimate_request_id_fkey FOREIGN KEY (estimate_request_id) REFERENCES public.estimate_requests(id) ON DELETE CASCADE;


--
-- Name: estimate_request_items estimate_request_items_original_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.estimate_request_items
    ADD CONSTRAINT estimate_request_items_original_product_id_fkey FOREIGN KEY (original_product_id) REFERENCES public.products(id) ON DELETE RESTRICT;


--
-- Name: estimate_request_items estimate_request_items_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.estimate_request_items
    ADD CONSTRAINT estimate_request_items_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE RESTRICT;


--
-- Name: estimate_request_items estimate_request_items_sub_feature_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.estimate_request_items
    ADD CONSTRAINT estimate_request_items_sub_feature_id_fkey FOREIGN KEY (sub_feature_id) REFERENCES public.sub_features(id) ON DELETE RESTRICT;


--
-- Name: estimate_request_items estimate_request_items_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.estimate_request_items
    ADD CONSTRAINT estimate_request_items_template_id_fkey FOREIGN KEY (template_id) REFERENCES public.estimate_templates(id) ON DELETE RESTRICT;


--
-- Name: estimate_request_phase_lines estimate_request_phase_lines_item_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.estimate_request_phase_lines
    ADD CONSTRAINT estimate_request_phase_lines_item_fk FOREIGN KEY (estimate_request_item_id) REFERENCES public.estimate_request_items(id) ON DELETE CASCADE;
...
--
-- Name: estimate_request_question_answers estimate_request_question_answers_item_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.estimate_request_question_answers
    ADD CONSTRAINT estimate_request_question_answers_item_fk FOREIGN KEY (estimate_request_item_id) REFERENCES public.estimate_request_items(id) ON DELETE CASCADE;
...
\unrestrict 9QuFDe3C4nB8v8uvkgLPcrgKXVqmIVEumbedp9JACsKYYgR9q9OoHBdGMpJwOEY
